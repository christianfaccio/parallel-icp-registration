#!/usr/bin/env bash
#
# Runs bin/vectorized/icp_vectorized over a geometric sweep of n that brackets the
...
BIN="$HERE/bin/vectorized/icp_vectorized_v1"

OUT="${1:-out/vectorized/vectorized_v1.csv}"
